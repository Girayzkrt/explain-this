...
export default defineConfig({
  ...
  manifest: (environment) => {
    ...
    const e2eHostPermissions = e2eEndpoints ? ["http://127.0.0.1/*"] : [];
  ...
  vite: (environment) => {
    ...
    return {
      define: {
        ...
        __EXPLAIN_THIS_E2E_READER_HOOK_NAME__: JSON.stringify(
          e2eEndpoints === undefined ? undefined : "__EXPLAIN_THIS_E2E_INVOKE_READER__",
        ),
        __EXPLAIN_THIS_E2E_STREAM_TIMEOUT_MS__: JSON.stringify(
          e2eEndpoints === undefined ? undefined : 1_500,
        ),
      },
    };
  },
